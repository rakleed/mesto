...
const editPopupProfileName = document.querySelector('.edit-popup__input_title_name');
const editPopupProfileAbout = document.querySelector('.edit-popup__input_title_about');
const addPopupCardTitle = document.querySelector('.add-popup__input_title_title');
const addPopupCardLink = document.querySelector('.add-popup__input_title_link');
